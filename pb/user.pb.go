...
type FindUserByUsernameAndPasswordRequest struct {
...
func (x *FindUserByUsernameAndPasswordRequest) Reset() {
	*x = FindUserByUsernameAndPasswordRequest{}
...
func (x *FindUserByUsernameAndPasswordRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindUserByUsernameAndPasswordRequest) ProtoMessage() {}

func (x *FindUserByUsernameAndPasswordRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pb_user_proto_msgTypes[0]
...
// Deprecated: Use FindUserByUsernameAndPasswordRequest.ProtoReflect.Descriptor instead.
func (*FindUserByUsernameAndPasswordRequest) Descriptor() ([]byte, []int) {
	return file_pb_user_proto_rawDescGZIP(), []int{0}
}

func (x *FindUserByUsernameAndPasswordRequest) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *FindUserByUsernameAndPasswordRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_pb_user_proto_rawDesc = []byte{
	...
	0x5e, 0x0a, 0x24, 0x46, 0x69, 0x6e, 0x64, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79, 0x55, 0x73, 0x65,
	0x72, 0x6e, 0x61, 0x6d, 0x65, 0x41, 0x6e, 0x64, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64,
	...
	,
...
var file_pb_user_proto_goTypes = []interface{}{
	(*FindUserByUsernameAndPasswordRequest)(nil), // 0: FindUserByUsernameAndPasswordRequest
	(*User)(nil), // 1: User
}
var file_pb_user_proto_depIdxs = []int32{
	0, // 0: UserService.FindUserByUsernameAndPassword:input_type -> FindUserByUsernameAndPasswordRequest
	1, // 1: UserService.FindUserByUsernameAndPassword:output_type -> User
...
func file_pb_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pb_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FindUserByUsernameAndPasswordRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
